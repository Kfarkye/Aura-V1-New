...
code = code.replace(
  ...
  '<div className="flex w-full h-full overflow-hidden gap-5 p-5 bg-[#030303] font-sans text-white selection:bg-white/20">'
);
code = code.replace(
  '<div className="flex-1 flex flex-col min-w-0 relative z-10 bg-[#050505] overflow-hidden border-r border-[rgba(255,255,255,0.08)]">',
  '<div className="flex-1 flex flex-col min-w-0 relative z-10 bg-white/[0.02] backdrop-blur-3xl rounded-[24px] overflow-hidden border border-white/[0.06] shadow-2xl">'
);
...
code = code.replace(
  ...
  '<div className="w-[440px] flex-shrink-0 bg-white/[0.03] backdrop-blur-3xl rounded-[24px] flex flex-col z-20 border border-white/[0.06] shadow-2xl">'
);
...
code = code.replace(/text-\[rgba\(255,255,255,0\.5\)\]/g, "text-white/50");
